  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">2. Use License</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">3. Disclaimer</h2>
          <p className="text-slate-600 dark:text-slate-400 mb-4">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4. Limitation of Liability</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">5. Accuracy of Information</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">6. Contact Information</h2>
          <p className="text-slate-600 dark:text-slate-400">
