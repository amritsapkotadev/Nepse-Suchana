...
export default function DisclaimerPage() {
  return (
    <div className="max-w-4xl mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold text-slate-900 dark:text-white mb-8">Disclaimer</h1>
      ...
      <div className="prose dark:prose-invert max-w-none">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">1. No Financial Advice</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">2. Accuracy of Data</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">3. Demo Trading - No Real Money</h2>
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">4. Investment Risk</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">5. Third-Party Links</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">6. No Warranty</h2>
          <p className="text-slate-600 dark:text-slate-400">
        ...
        <section className="mb-8">
          <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-4">7. By Using This App</h2>
          <p className="text-slate-600 dark:text-slate-400">
