      ...
      <div className="mb-8">
        <div className="relative max-w-2xl mx-auto">
          <input
            ...
            className="w-full px-6 py-4 pl-14 text-base border-2 border-slate-300 rounded-xl bg-white text-slate-900 placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500:ring-blue-400 focus:border-transparent shadow-lg"
          />
          <svg
          ...
          {searchQuery && (
            <button
              ...
              className="absolute right-4 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-slate-600:text-slate-200 p-1 rounded-full hover:bg-slate-100:bg-slate-800"
            >
        ...
        {searchQuery && (
          <div className="absolute left-0 right-0 mx-auto max-w-2xl mt-2 z-50">
            <div className="bg-white rounded-xl shadow-2xl border border-slate-200 max-h-96 overflow-y-auto">
                  ...
                  <div className="divide-y divide-slate-200">
                    {filteredStocks.map((stock) => (
                      <div
                        ...
                        className="px-4 py-3 hover:bg-slate-50:bg-slate-750 cursor-pointer transition-colors"
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex-1">
                            <div className="flex items-center gap-2">
                              ...
                              <span className={`px-2 py-0.5 rounded text-xs font-medium ${stock.change >= 0 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'}`}>
